...
use cryptopals::{
    cracker::Cracker,
    xor::{XorType, fixed_xor, otp, repeating_xor, single_xor},
    demos,
...
fn main() -> Result<()> {
    ...
    match args.command {
        ...
        Commands::Demo { challenge } => {
            ...
            match challenge {
                ChallengeId::S1C1 => demos::run_challenge_1(),
                ChallengeId::S1C2 => demos::run_challenge_2(),
                ChallengeId::S1C3 => demos::run_challenge_3(),
                ChallengeId::S1C4 => demos::run_challenge_4(),
                ChallengeId::S1C5 => demos::run_challenge_5(),
                //ChallengeId::S1C6 => demos::run_challenge_6(),
                ChallengeId::S4C29 => demos::run_challenge_29(),
                ChallengeId::S5C33 => demos::run_challenge_33(),
                ChallengeId::S5C36 => demos::run_challenge_36(),
                ChallengeId::S5C39 => demos::run_challenge_39(),
                ChallengeId::S5C40 => demos::run_challenge_40(),
